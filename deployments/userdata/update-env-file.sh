...
# aws --region ap-southeast-2 s3 cp env-file.zip s3://janxv-env-files/staging/
...
# Download every content in the staging folder
aws s3 sync s3://janxv-env-files/staging .
